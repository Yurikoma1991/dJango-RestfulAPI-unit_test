...
class ArticleListViewTestCase(TestCase):
    ...
    def test_creates_new_article_with_regions_and_authors(self):
        payload = {
        ...
        self.assertDictEqual(
            {
                ...
                "authors":[
                    {"id": authors.all()[0].id, "first_name": "Lionel", "last_name": "Messi"},
                ]
            },
            response.json(),
        )
...
class ArticleViewTestCase(TestCase):
    def setUp(self):
        ...
        self.author = Author.objects.create(first_name="Lionel", last_name="Messi")
    ...
    def test_updates_article_and_regions(self):
        ...
        payload = {
            ...
            "authors": [
                {"id": self.author.id, "first_name": "Lionel", "last_name": "Messi"},
            ]
        }
